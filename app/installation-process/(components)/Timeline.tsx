...
export default function Timeline() {
  ...
  return (
    <section ref={containerRef} className="py-24 bg-[#fefefe] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto text-lg font-light">
            A clear breakdown of your transition to clean energy, from the first visit to full system activation.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div 
            ref={lineRef}
            className="absolute top-12 left-0 w-full h-[2px] bg-brand-red origin-left hidden lg:block shadow-[0_0_10px_rgba(255,105,0,0.3)]" 
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-4 relative">
            {steps.map((step, index) => (
              ...
              >
                ...
                <p className="text-gray-500 text-sm font-light leading-relaxed max-w-[180px]">
                  {step.description}
                </p>
              </div>
            ))}
