...
const steps = [
  {
    ...
    description: "Your journey to clean energy begins with a personalized assessment of your home's potential.",
    points: [
  ...
  },
  {
    ...
    description: "Our engineering experts conduct a thorough technical evaluation of your property.",
    points: [
      "3D roof mapping & shadow analysis",
      "Structural integrity verification",
      "Electrical system compatibility check"
    ],
    image: "/images/rooftop-solar-2.webp",
  },
  {
    number: "03",
    title: "Custom System Design",
    description: "We engineer a high-performance system optimized for maximum sunlight capture.",
    points: [
  ...
  },
  {
    ...
    description: "We navigate the complex paperwork and regulatory requirements on your behalf.",
    points: [
  ...
  },
  {
    ...
    description: "Our certified technicians bring your solar vision to life with surgical precision.",
    points: [
  ...
  },
  {
    ...
    description: "We ensure everything is perfect before you start generating your own power.",
    points: [
...
export const Process = () => {
  ...
  return (
    <section ref={containerRef} className="relative py-24 lg:py-48 bg-[#fefefe] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        
        {/* Section Header */}
        <div className="text-center mb-32 lg:mb-48">
          <span className="inline-block px-4 py-1.5 rounded-full bg-emerald-50 text-emerald-600 text-sm font-bold tracking-wider uppercase mb-6">
            The Roadmap
          </span>
          <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-8 tracking-tight">
            Seamlessly Powered by <span className="text-emerald-500">Expertise</span>
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg lg:text-xl font-light">
            From the first handshake to the final switch-on, we manage every detail of your transition to clean energy.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div 
            ref={progressLineRef}
            className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-[2px] bg-emerald-500 origin-top shadow-[0_0_15px_rgba(16,185,129,0.3)] hidden lg:block" 
          />
          ...
          <div className="space-y-32 lg:space-y-48">
            {steps.map((step, index) => (
              ...
              >
                ...
                {/* Center Node (Desktop) */}
                <div className="timeline-node hidden lg:flex absolute left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-white border-2 border-emerald-500 z-10 items-center justify-center shadow-xl shadow-emerald-500/10">
                  <span className="text-emerald-600 font-bold text-sm">{step.number}</span>
                </div>

                {/* Text Content Column */}
                <div className="text-col w-full lg:w-[42%] space-y-6">
                  <div className="space-y-4">
                    <span className="lg:hidden inline-block text-emerald-600 font-bold text-lg mb-2">Step {step.number}</span>
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-emerald-50/20 rounded-full blur-[120px] -z-10" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-emerald-50/20 rounded-full blur-[120px] -z-10" />
    </section>
  );
};
