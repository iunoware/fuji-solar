        ...
        <div className="flex flex-col lg:flex-row flex-1 max-w-7xl mx-auto w-full px-8 md:px-16 py-20 gap-16 lg:gap-24">
          ...
          <div className="svc-left-col lg:w-[38%] flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-8">
              {services.map((service, i) => (
                <div key={service.id} className="flex items-start gap-5">
                  <span
          ...
          <div className="lg:w-[62%] relative flex items-center">
            {services.map((service, i) => (
              ...
              >
                {/* Image */}
                <div className="w-full h-48 mb-7 rounded-2xl overflow-hidden bg-[#f9f6f1]">
                  <Image
                    fill
                    src={service.image}
                    alt={service.title}
                ...
                <p className="text-base md:text-lg leading-relaxed mb-6 max-w-xl text-[#78716c]">
                  {service.description}
                </p>
        ...
        <div className="flex flex-col gap-12">
          {services.map((service, i) => (
            <div key={service.id} className="flex flex-col gap-6">
              ...
              {/* Image */}
              <div className="w-full h-44 rounded-2xl overflow-hidden bg-[#f9f6f1]">
