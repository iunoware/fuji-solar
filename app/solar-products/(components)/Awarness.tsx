      ...
      >
        ...
        <div ref={leftRef} className="flex flex-col">
          ...
          <h2 className="text-[clamp(36px,5vw,56px)] leading-[1.1] font-bold text-gray-900 mb-6 tracking-tight">
            Take a <span className="text-brand-red">Decision</span><br />
            Today.
          </h2>
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed max-w-xl font-medium">
            ...
            <span className="text-brand-red font-semibold">free energy</span> is
            both practical and necessary for a sustainable future.
          </p>
            ...
            <div className="relative z-10 flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  of CO₂ emissions can be saved for every <strong className="text-gray-900">100 kWh</strong> of solar energy produced.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="relative">
          <div className="absolute -inset-4 bg-gradient-to-b from-gray-100/50 to-transparent rounded-3xl -z-10" />
          
          <div className="mb-10 lg:mb-12">
            <h3 className="text-2xl font-bold text-gray-900">How Solar Power Works</h3>
            <p className="text-gray-500 mt-2 text-sm">A simple, seamless three-step process.</p>
          </div>

          <div ref={rightRef} className="flex flex-col gap-5">
            {/* Step 1 */}
            <div className="step-card group bg-white border border-gray-100 p-5 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 hover:border-brand-red/20 relative overflow-hidden flex gap-5 items-start">
               <div className="bg-gray-50 group-hover:bg-brand-red group-hover:text-white transition-colors duration-300 p-4 rounded-xl shrink-0">
                  <Sun className="w-6 h-6" />
               </div>
               <div>
                  <div className="flex items-center gap-3 mb-1">
                    <span className="text-xs font-bold text-brand-red tracking-wider uppercase">01</span>
                    <h4 className="text-lg font-bold text-gray-900">Solar Panels</h4>
                  </div>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Capture and convert sunlight directly into electricity using the highly efficient photovoltaic effect.
                  </p>
               </div>
            </div>
            ...
            <div className="step-card group bg-white border border-gray-100 p-5 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 hover:border-brand-red/20 relative overflow-hidden flex gap-5 items-start">
               ...
               <div>
                  <div className="flex items-center gap-3 mb-1">
                    <span className="text-xs font-bold text-brand-red tracking-wider uppercase">02</span>
                    <h4 className="text-lg font-bold text-gray-900">Inverter System</h4>
                  </div>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Converts the generated raw DC power into stable, usable AC power for your household appliances.
                  </p>
               </div>
            </div>
            ...
            <div className="step-card group bg-white border border-gray-100 p-5 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 hover:border-brand-red/20 relative overflow-hidden flex gap-5 items-start">
               ...
               <div>
                  <div className="flex items-center gap-3 mb-1">
                    <span className="text-xs font-bold text-brand-red tracking-wider uppercase">03</span>
                    <h4 className="text-lg font-bold text-gray-900">Seamless Usage</h4>
                  </div>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Powers your home effortlessly, utilizing the smart grid or battery storage during low sunlight conditions.
                  </p>
               </div>
            </div>
          </div>
