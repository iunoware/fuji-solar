...
export default function Footer() {
  ...
  return (
    <div className="bg-[#fefefe]">
      <footer className="relative bg-brand-yellow/30 border-t border-gray-100 pt-20 overflow-hidden font-montserrat">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-16">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <nav className="flex flex-col gap-4">
                {["About Us", "Calculator", "Testimonials", "Contact"].map((item) => (
                  <Link
                    key={item}
                    href="#"
                    className="text-gray-800 hover:text-brand-red text-sm transition-colors flex items-center gap-1 group"
